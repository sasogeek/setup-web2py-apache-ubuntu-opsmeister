...
2) install web2py in /home/"$SUDO_USER"/www-data/
...
chown -R $SUDO_USER:$SUDO_USER web2py
...
echo "================================================="
echo '
WSGIDaemonProcess web2py user='$SUDO_USER' group='$SUDO_USER'

<VirtualHost *:80>

 WSGIProcessGroup web2py
  WSGIScriptAlias / /home/'$SUDO_USER'/www-data/web2py/wsgihandler.py
  WSGIPassAuthorization On

  <Directory /home/'$SUDO_USER'/www-data/web2py>
    AllowOverride None
    Require all denied
  ...
  AliasMatch ^/([^/]+)/static/(?:_[\d]+.[\d]+.[\d]+/)?(.*) \
        /home/'$SUDO_USER'/www-data/web2py/applications/$1/static/$2

  <Directory /home/'$SUDO_USER'/www-data/web2py/applications/*/static/>
    Options -Indexes
    ExpiresActive On
...
cd /home/$SUDO_USER/www-data/web2py
sudo -u $SUDO_USER python -c "from gluon.widget import console; console();"
sudo -u $SUDO_USER python -c "from gluon.main import save_password; save_password(raw_input('web2py admin password: '),443)"
echo "done!"
